...
At this time, this setting cannot be manipulated from [Sandboxie Control](SP_SBControl.md). You have to manually edit it into [Sandboxie Ini](SandboxieIni.md).
