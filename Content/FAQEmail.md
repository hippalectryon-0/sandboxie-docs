...
A. You can use the _Run Email Reader_ command from the [Sandbox Menu](SP_SBControl_SandboxMenu.md) or [Tray Icon Menu](SP_TrayIconMenu.md) of [Sandboxie Control](SP_SBControl.md). You can also right-click _Run Sandboxed_ on the program icon for your email software.
