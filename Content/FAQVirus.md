...
A. No. The anti-virus itself is not operating under the supervision of Sandboxie, even if the virus alert seems to indicate otherwise. Operating outside the sandbox, the anti-virus can reach into the sandbox folder, pull the virus file, and move it into quarantine. The process is similar to Sandboxie [Recovery](SP_Recovery.md), wherein [Sandboxie Control](SP_SBControl.md) reaches inside the sandbox to pull some file out of it.
