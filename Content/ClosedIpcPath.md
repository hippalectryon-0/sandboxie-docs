...
Related [Sandboxie Control](SP_SBControl.md) setting: [Sandbox Options > Resource Access > IPC Access > Blocked Access](ResourceAccessSettings.md#ipc-access--blocked-access)
