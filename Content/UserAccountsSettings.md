...
A user account to which any sandboxes are hidden will have the [Reveal Hidden Sandbox](SP_SBControl_SandboxMenu.md#reveal-hidden-sandbox) command appear in the [Sandbox Menu](SP_SBControl_SandboxMenu.md) in [Sandboxie Control](SP_SBControl.md).
